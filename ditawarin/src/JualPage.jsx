            ...
            <div className='container fontcustom'>
                ...
                <form className='row' onSubmit={handleSubmit(addItem)}>
                    <div className='col-md-6'>
                        <input id='productname_inp' type="text" {...register("namabarang", { required: { value: true, message: "Nama Barang wajib diisi" } })} placeholder="Nama Produk*" className="mt-1 mb-3 ps-3 border border-secondary-subtle" style={{ borderRadius: "10px", width: "90%", height: "3rem" }} />
                        {errors.namabarang && <p style={{ color: "red" }}>{errors.namabarang.message}</p>}
                        <br />
                        <input id='startprice_inp' type="number" {...register("starting_price", { required: { value: true, message: "Starting Price wajib diisi" } })} placeholder="Starting Price*" className="mt-1 mb-3 ps-3 border border-secondary-subtle" style={{ borderRadius: "10px", width: "90%", height: "3rem" }} />
                        {errors.starting_price && <p style={{ color: "red" }}>{errors.starting_price.message}</p>}
                        <br />
                        <input id='askprice_inp' type="number" {...register("asking_price", { required: { value: true, message: "Asking Price wajib diisi" } })} placeholder="Asking Price*" className="mt-1 mb-3 ps-3 border border-secondary-subtle" style={{ borderRadius: "10px", width: "90%", height: "3rem" }} />
                        {errors.asking_price && <p style={{ color: "red" }}>{errors.asking_price.message}</p>}

                        <br />
                        <input id='kec_inp' type="text" {...register("kecamatan", { required: { value: true, message: "Lokasi Kecamatan wajib diisi" } })} placeholder="Kecamatan*" className="mt-1 mb-3 ps-3 border border-secondary-subtle" style={{ borderRadius: "10px", width: "90%", height: "3rem" }} />
                        {errors.kecamatan && <p style={{ color: "red" }}>{errors.kecamatan.message}</p>}
                        <br />
                        <input id='kota_inp' type="text" {...register("kota_kabupaten", { required: { value: true, message: "Lokasi Kota/Kabupaten wajib diisi" } })} placeholder="Kota/Kabupaten*" className="mt-1 mb-3 ps-3 border border-secondary-subtle" style={{ borderRadius: "10px", width: "90%", height: "3rem" }} />
                        {errors.kota_kabupaten && <p style={{ color: "red" }}>{errors.kota_kabupaten.message}</p>}
                        <br />
                        <input id="prov_inp" type="text" {...register("provinsi", { required: { value: true, message: "Lokasi Provinsi wajib diisi" } })} placeholder="Pronvinsi*" className="mt-1 mb-3 ps-3 border border-secondary-subtle" style={{ borderRadius: "10px", width: "90%", height: "3rem" }} />
                        ...
                        <div className="row mb-3">
                            <div className="col-md-6">
                                ...
                                <input id="elektronik_chk" type="checkbox" style={{ width: "15px", height: "15px" }} {...register("kategori")} value={"Elektronik"} /><label htmlFor="" className="ms-4 h6">Elektronik</label><br />
                    ...
                    <div className='col-md-6 text-center'>
                        ...
                        <br />
                        <textarea id='desc_inp' {...register("deskripsi", { required: { value: true, message: "Deskripsi Barang wajib diisi" } })} placeholder="Deskripsi Barang*" className="mt-1 mb-3 ps-3 border border-secondary-subtle" style={{ borderRadius: "10px", width: "90%", height: "10rem" }}></textarea>
                        {errors.namabarang && <p style={{ color: "red" }}>{errors.namabarang.message}</p>}
                        <button id='add_btn' type="submit" className='btn bg-dark text-white mx-auto w-25 pt-3 pb-3 mt-4'>Add Item</button>
                    </div>
                </form>
            </div>
        </>
