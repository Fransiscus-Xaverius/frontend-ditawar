...
export default function SearchItem(props){
    ...
    return (
        <>
        <div className="container" onClick={()=>{moveToAuction()}}>
            <div className="card mb-3 mt-4" style={{height: "30vh", width: "70vw"}}>
                        ...
                        <div className="row mb-3">
                            <div className="col-6">
                                <p className="card-text" style={{fontSize: "20px"}}>
                                    Starting at : {Rupiah.format(props.auction.starting_price)}
                                </p>
                                <p className="card-text" style={{fontSize: "20px"}}>
                            ...
                            <div className="col-6">
                                ...
                                {props.auction.kecamatan},{props.auction.kota_kabupaten},{props.auction.provinsi}
                            </div>
                        </div>
                        <p className="card-text overflow-hidden h-25" style={{fontSize: "15px", height:"50%", overflowY:"hidden"}}>
